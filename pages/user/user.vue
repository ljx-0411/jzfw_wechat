		 ...
		 <view class='order'>
		  ...
		  <view class='list'>
		    <view class='section'>
		     ...
		     <navigator class='row' url='../address/address'>
		       <view class='left'>
		         <img class='icon' src='/static/img/user/wodedizhi.png'/>
		         <text class='text'>我的地址</text>
		       </view>
		       <img class='arrow' src='/static/img/arrow-right.png'/>
		     </navigator>
		     
		      <navigator class='row' open-type="switchTab" url='../order/order'>
		        <view class='left'>
		    ...
		    <view class='section'>
		      <navigator class='row' url='../userAccountDetail/userAccountDetail'>
		        <view class='left'>
		    ...
		    <button open-type="share"></button>
		        ...
		        <view class='left'>
		          <img class='icon' src='/static/img/user/fenxiang.png'/>
